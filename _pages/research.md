...
Recently, we are developing a novel co-expression modeling method, named [spCorr (Genome Research, 2026+)](https://github.com/chexjiang/spCorr), for detecting the **dynamic co-expression changes across different locations** in spatial transcriptomics. By using a novel regression model, spCorr is very flexible and can deal with various confounding effects.
</div>
